...
function profilListesi(dizi) {
  ...
  for (let i = 0; i < yeniDizi.length; i++) {
    const profile = yeniDizi[i].profile;
    yeniDizi[i] = profile;
  }
  return yeniDizi;
}
...
function enFenomenler(dizi) {
  ...
  for (let i = 0; i < dizi.length; i++) {
    const eleman = dizi[i];
    if (eleman.followers > 100000000) {
      yeniDizi.push(eleman.profile);
    }
  }
  return yeniDizi;
}
...
function platformaGoreCokGonderiYapanFenomen(dizi, platform){
  ...
  for (let i = 0; i < dizi.length; i++) {
    const eleman = dizi[i];
    if (eleman.platform === platform) {
      yeniDizi.push(eleman);
    }
  }
  yeniDizi.sort((a,b) => a.posts -b.posts);
  yeniDizi.reverse();
  return yeniDizi[0].profile;
}

console.table(platformaGoreCokGonderiYapanFenomen(fenomenler, 'TikTok'));
